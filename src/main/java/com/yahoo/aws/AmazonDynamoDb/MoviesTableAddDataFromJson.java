...
public class MoviesTableAddDataFromJson {

	public static void main(String[] args) throws Exception {

		new MoviesTableAddDataFromJson().loadDataFromJsonFile();
	}
	...
	public void loadDataFromJsonFile() throws Exception {
		...
		JsonParser parser = new JsonFactory()
				.createParser(new File(classLoader.getResource("moviedataMini.json").getFile()));
